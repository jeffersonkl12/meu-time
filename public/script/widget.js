import { livescore } from "./library/livescore.js";
import { fixtures } from "./library/fixtures.js";
import { fixture } from "./library/fixture.js";
import { standings } from "./library/standings.js";
  ...
  if (document.getElementById("wg-api-football-livescore")) {
    ...
    if ("false" !== i && !e) {
      ...
      (t.type = "text/css"),
        (t.rel = "stylesheet"),
        (t.href =
          "https://widgets.api-sports.io/football/1.1.8/themes/api-football.css"),
    ...
    if (("grey" === i || "dark" === i) && !a) {
      ...
      (t.type = "text/css"),
        (t.rel = "stylesheet"),
        (t.href =
          "https://widgets.api-sports.io/football/1.1.8/themes/api-football-" +
          i +
          ".css"),
        document.getElementsByTagName("head")[0].appendChild(t);
    }
  ...
  document.addEventListener(
    ...
    function (t) {
      ...
      for (var o = 0; o < l.length; o++) {
        let t = l[o];
        t.classList.contains("api_football_hide")
          ? (t.classList.remove("api_football_hide"),
            e.classList.remove("api_football_arrow_down"),
            e.classList.add("api_football_arrow_up"))
          : (t.classList.add("api_football_hide"),
            e.classList.remove("api_football_arrow_up"),
            e.classList.add("api_football_arrow_down"));
      }
    },
    !1
  ),
    document.addEventListener(
      ...
      function (t) {
        ...
        for (o = 0; o < i.length; o++) {
          let t = i[o];
          t.getAttribute("data-id") !== a &&
            t.classList.contains("api_football_active") &&
            t.classList.remove("api_football_active");
        }
    ...
    document.addEventListener(
      ...
      function (e) {
        ...
        let a,
          ...
          m = null,
          u = null;
        document.getElementById("wg-api-football-livescore")
          ? ((r = document.getElementById("wg-api-football-livescore")),
            (d = r.getAttribute("data-key")),
            (n = r.getAttribute("data-host")),
            (m = r.getAttribute("data-show-errors")),
            (u = parseInt(1e3 * r.getAttribute("data-refresh"))))
          : document.getElementById("wg-api-football-fixtures") &&
            ((r = document.getElementById("wg-api-football-fixtures")),
            (d = r.getAttribute("data-key")),
            (n = r.getAttribute("data-host")),
            (m = r.getAttribute("data-show-errors")),
            (u = parseInt(1e3 * r.getAttribute("data-refresh")))),
          null !== r &&
            (document.getElementById("wg-api-football-fixture-modal") &&
              document.getElementById("wg-api-football-fixture-modal").remove(),
            ((a = document.createElement("div")).id = "wb-api-football-modal"),
            ...
            o.classList.add("api_football_loader"),
            l.appendChild(o),
            r.appendChild(a),
    ...
    document.addEventListener(
      "click",
      function (e) {
        e.target.matches(".api_football_modal_close") &&
          (e.preventDefault(),
          clearInterval(t),
          document.getElementById("wb-api-football-modal") &&
            ((document.getElementById("wb-api-football-modal").style.display =
              "none"),
            document.getElementById("wb-api-football-modal").remove()));
      },
      !1
    );
});
